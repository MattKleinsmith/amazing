...
export default function ReviewForm() {
    ...
    const handleImageChange = async (e) => {
        ...
        if (review?.id && file) {
            ...
            reader.onload = function (e) {
                const newReviewImageUrls = new Set(reviewImageUrls);
                newReviewImageUrls.add(e.target.result);
                setReviewImageUrls(newReviewImageUrls);

                const newReviewImageFiles = { ...reviewImageFiles };
                newReviewImageFiles[e.target.result] = file;
                setReviewImageFiles(newReviewImageFiles);
            }
    ...
    const onClickContinue = async () => {
        ...
        try {
            ...
            try {
                if (newReviewId) {
                    for (const file of Object.values(reviewImageFiles)) {
                        await dispatch(postReviewImage(newReviewId, file));
                    }
                }
            }
            catch (responseBody) {
    ...
    const onLocalImageDelete = (url) => {
        const newReviewImageUrls = new Set(reviewImageUrls);
        newReviewImageUrls.delete(url);
        setReviewImageUrls(newReviewImageUrls);

        const newReviewImageFiles = { ...reviewImageFiles };
        delete newReviewImageFiles[url];
        setReviewImageFiles(newReviewImageFiles);
                ...
                <form className={styles.form} onSubmit={onSubmit}>
                    ...
                    <div className={styles.images}>
                        <div className={styles.images} ref={imageRef}>
                            ...
                            {reviewImageUrls.size > 0 && Array.from(reviewImageUrls).map((url, i) =>
                                <Fragment key={i}>
                                    <img src={url} alt="" className={styles.reviewImage} />
                                    <div onClick={() => onLocalImageDelete(url)} className={styles.deleteWrapper} >
                                        <div className={styles.delete} />
                                    </div>
                                </Fragment>
                            )}
                        ...
                        {!review && reviewImageUrls.size < 4 && <label htmlFor="image" className={styles.addPhoto}>
                            <img alt="" src="data:image/svg+xml;base64," />
                        </label>}
                    </div>
