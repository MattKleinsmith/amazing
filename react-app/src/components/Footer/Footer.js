        ...
        <div className={styles.wrapper}>
            <div className={styles.footer}>
                <div className={styles.content}>
                    <a target="_blank" href="https://www.linkedin.com/in/matthewkleinsmith/" className={styles.link}>
                        <img className={styles.linkedinIcon} src="/images/linkedin.png" alt="linkedin logo" />
                    </a>
                    <a target="_blank" href="https://github.com/MattKleinsmith/" className={styles.link}>
                    ...
                    <a target="_blank" href="https://github.com/MattKleinsmith/amazing/" className={styles.link}><h2>Project repo</h2></a>
                </div>
            </div>
        </div>
    );
